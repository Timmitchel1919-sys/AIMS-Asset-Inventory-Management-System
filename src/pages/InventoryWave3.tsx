...
export function InventoryList(){
  ...
  return <OfflineGate><div className="page"><PageHeader title={nl?'Magazijnvoorraad':'Warehouse inventory'} description={nl?'Hoeveelheidsvoorraad, opslag en herbevoorrading.':'Quantity stock, storage and replenishment.'} actions={<><Link className="btn btn-secondary page-header-secondary-action" to="/inventory/import">{nl?'Importeren':'Import'}</Link><Link className="btn btn-primary" to="/inventory/new"><PackagePlus/>{nl?'Artikel toevoegen':'Add item'}</Link></>}/>

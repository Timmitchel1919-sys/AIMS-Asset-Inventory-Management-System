...
export default function SupportPage(){
  ...
  return <main className="legal-page support-page"><div className="legal-page__container">
    <header className="legal-page__header"><Link className="legal-page__back" to="/login">← {nl?'Terug':'Back'}</Link><img className="legal-page__logo" src="/aims-logo.png" alt="AIMS"/><p className="legal-page__eyebrow">{legalConfig.systemName}</p><h1>{nl?'ICT-ondersteuning, privacy en beveiliging':'ICT Support, Privacy & Security'}</h1><p>{nl?'Neem contact op met de KCS ICT-afdeling voor technische ondersteuning, privacyvragen, individuele verzoeken of vermoedelijke beveiligingsincidenten.':'Contact the KCS ICT Department for technical support, privacy questions, individual requests, or suspected security incidents.'}</p></header>
